...
from preclasses import RESERVED_FILENAMES, Segment, SegmentList
...
def write_spec_files():
   spec = RESERVED_FILENAMES['spec']  # possibly 'tab_spec.txt' or similar
...
def write_cfg():
    cfg = RESERVED_FILENAMES['cfg'] # possibly 'tab_cfg.txt' of similar
