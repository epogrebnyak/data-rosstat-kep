...
-------------------------------------
- сейчас end-to-end тестиирование это файл [reader.py](https://github.com/epogrebnyak/data-rosstat-kep/blob/kep2/kep2/reader.py)
...
**2.1 Обустраивать имеющийся код:**
- прокомментировать этот файл
- разные FIX и TODO в текущих файлах
...
**2.3 докуменатция** 
 - сделать скрипт под windows, который генерирует документацю для kep2 с помощью pydoc (отдельно стоящие файлы 
   удается генерировать, а для всего пакета - нет). SPHINX просьба не предлагать.
