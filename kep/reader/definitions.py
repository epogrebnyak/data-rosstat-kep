# -*- coding: utf-8 -*-
"""
Created on Fri Mar 31 14:00:45 2017
...
class ParsingDefinition():
    ...
    ParsingDefinition(data_folder)               
    ParsingDefinition(csv_path, cfg_path)
    ParsingDefinition(csv_content, cfg_content, folder)
    ParsingDefinition(csv_content, [spec_content1, spec_content2])
    ...
    def __init__(self, *arg):
        ...
        # csv_input + list of filenames + spec folder    
            ...
            raise Exception("Wrong number of arguments for ParsingDefinition() given: " + str(len(arg)) )         
...
class CoreRowSystem(ParsingDefinition):
